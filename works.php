                    ...
                    <div class="brain-image">
                        <div class="wrapper">
                            <div class="animate">
                                ...
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/works/rightbottom.svg" alt="" class="rightbottom element">
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/works/righttoptext.svg" alt="text" class="element righttoptext">
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/works/leftbottom.svg" alt="" class="leftbottom element">
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/works/rightbottomtext.svg" alt="text" class="element rightbottomtext">
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/works/lefttop.svg" alt="" class="lefttop element">
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/works/leftbottomtext.svg" alt="text" class="leftbottomtext element">
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/works/righttop.svg" alt="" class="righttop element">
                                <img src="<?php echo get_template_directory_uri() ?>/assets/img/works/bottom.svg" alt="" class="element bottom">
